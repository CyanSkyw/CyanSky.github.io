class EchartNdgycwxx extends EchartsMain {
...
let echartNdgycwxx=new EchartNdgycwxx('echartNdgycwxx');
echartsList.push(echartNdgycwxx);

let ndgycwxxDropDown=document.querySelector('#ndgycwxxDropDown');
ndgycwxxDropDown.addEventListener('select',(event)=>{
    let [text]=event.detail;
    echartNdgycwxx.setOption(echartNdgycwxx.getOption());
    console.log(text);
})
